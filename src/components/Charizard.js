...
class Charizard extends Component{
    render () {
      return (
        <div>
            ...
            <div> 
              <button type="button" class="bg-white py-1 px-4 ml-20 mt-1 rounded-lg border-2 border-yellow-500 " data-toggle="collapse" data-target="#charizard">
                  <span class="font-bold">Info</span> 
              </button>
            </div>              

            <div className="bg-white px-2 py-2 rounded-lg border-2 border-yellow-500 collapse" id="charizard">
